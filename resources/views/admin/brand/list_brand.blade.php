    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{ url('create-brand') }}" class="btn btn-primary shadow-md mr-2">Add New Brand</a>
                <div class="dropdown">
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="flex">
                                    <div class="col-span-6 sm:col-span-3 lg:col-span-2 xl:col-span-1 mx-3">
                                        <a href="{{ url('/edit-brand', $item->id) }}" data-id="{{ $item->id }}">
                                            <i data-lucide="edit" class="block mx-auto"></i>
                                        </a>
                                    </div>
                                    <form class="delete-form" action="{{ url('/delete-brand', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
